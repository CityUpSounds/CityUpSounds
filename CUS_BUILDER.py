...
for d in dictionary:        
    ...
    with open(page,'a') as a:  
        ...
        a.write('<img class="cardThumbnail" src="'+ valuePageImagePath +'" alt="'+ valuePageTitle +'">\n')
...
for d in dictionary: 
    ...
    with open(page,'a') as a:  
        ...
        a.write('<img src="../img/'+ valuePageImagePath +'" alt="'+ valuePageTitle +'">\n')
        a.write('</div>\n')
        a.write('</section>\n')
        ...
        a.write('<img loading="lazy" src="'+ productTwoImagePath +'" alt="'+ productTwoName +'">\n')
        a.write('</a>\n')
        a.write('<a href="'+ productOneURL +'" class="page_products_image">\n')
        a.write('<img loading="lazy" src="'+ productOneImagePath +'" alt="'+ productOneName +'">\n')
        a.write('</a>\n')
        a.write('<a href="'+ productThreeURL +'" class="page_products_image">\n')
        a.write('<img loading="lazy" src="'+ productThreeImagePath +'" alt="'+ productThreeName +'">\n')
        a.write('</a>\n')
        a.write('</div>\n')
